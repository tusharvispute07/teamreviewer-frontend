      ...
      <div className="relative z-10 w-full max-w-sm m-auto p-6 md:p-8">
        <div className="mb-10 flex flex-col items-center">
          <div className="mb-8 flex items-baseline gap-1 select-none">
            ...
            {/* <div className="w-1.5 h-1.5 bg-zinc-400 rounded-full ml-0.5 mb-1"></div> */}
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="group">
            <div className="flex justify-between items-center mb-1.5">
              <label
                htmlFor="password"
                className="block text-xs font-medium text-zinc-500 uppercase tracking-widest group-focus-within:text-zinc-300 transition-colors"
              >
                Password
              </label>
